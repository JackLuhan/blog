...
import com.houyi.blog.business.entity.Tags;
...
import com.houyi.blog.business.service.BizTagsService;
import com.houyi.blog.business.service.RemoverService;
...
import com.houyi.blog.spider.model.Article;
import com.houyi.blog.spider.model.BaseModel;
import com.houyi.blog.spider.processor.ArticleSpiderProcessor;
import com.houyi.blog.spider.processor.BaseSpider;
import com.houyi.blog.spider.util.WriterUtil;
import com.houyi.blog.spider.webmagic.ZhydSpider;
...
//        List<Tags> tags = tagsService.listAll();
        ...
        // 添加文章到数据库
        com.houyi.blog.business.entity.Article article = null;
        // 处理标签，并获取最终待添加的标签id
        ...
        for (Article spiderArticle : list) {
            ...
            article = new com.houyi.blog.business.entity.Article();

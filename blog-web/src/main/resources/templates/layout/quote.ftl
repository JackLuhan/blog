    ...
    <link href="${config.staticWebSite}/css/houyi.core.css" rel="stylesheet" type="text/css">
    <link href="${config.staticWebSite}/css/houyi.comment.css" rel="stylesheet" type="text/css">
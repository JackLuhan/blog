                ...
                <div id="feed_widget">
                    <div class="feed-about">
                       ...
                       <ul class="list-unstyled">
                            <li><i class="fa fa-info-circle fa-fw"></i>博主：<small>鲁寒</small></li>
                            <li><i class="fa fa-user-circle fa-fw"></i>职业：<small>码农</small></li>
                            <li><i class="fa fa-home fa-fw"></i>籍贯：<small>大蜀山的某座洞里</small></li>
                            <li><i class="fa fa-weixin fa-fw"></i>微信：<small>Micro-se</small></li>
                            <li><i class="fa fa-envelope-square fa-fw"></i>邮箱：<small>1317406121@qq.com</small></li>
                        </ul>
                    </div>
                </div>
            </div>

                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="img-widget">
                        <div class="widget-header">
                            <a href="${config.wxCode}" target="_blank" class="showImage" title="[鹿小鹿同学]公众号" rel="external nofollow">
                                <img data-original="${config.wxCode}" alt="[鹿小鹿同学]公众号" class="img-responsive img-rounded auto-shake lazy-img">
                            </a>
                        </div>
                   ...
                   <#-- <div class="img-widget">
                        <div class="widget-header">
                            <a href="http://pgz6ei4sp.bkt.clouddn.com/qrcode_for_gh_d07677f719c0_258%20%281%29.jpg" target="_blank" class="showImage" title="微信公众号" rel="external nofollow">
                                <img data-original="http://pgz6ei4sp.bkt.clouddn.com/qrcode_for_gh_d07677f719c0_258%20%281%29.jpg" alt="微信公众号" class="img-responsive img-rounded auto-shake lazy-img" >
                            </a>
                        </div>
                        <div class="widget-footer">
                            <span>微信(备注:加群)</span>
...
<footer class="footer">
    <div class="clear">
        <p><a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank" title="查看备案信息" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">鲁ICP备17054970号-1</a></p>
        <p>Copyright&copy;2016-${.now?string("yyyy")} ${config.siteName} ·<a  title="一款简洁美观、自适应的Java博客系统..." data-toggle="tooltip" data-placement="right" target="_blank"><strong>后羿博客</strong></a> · <a href="http://tongji.baidu.com/web/welcome/ico?s=590226d2f4ffbf051442eb75f37333c9" target="_blank" title="点击查看${config.siteName}网站统计详情" data-toggle="tooltip" data-placement="right" rel="external nofollow"><i class="fa fa-bar-chart-o fa-fw"></i>网站统计</a></p>

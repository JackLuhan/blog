...
<script>
    ...
    function operateFormatter(code, row, index) {
        ...
        var operateBtn = [
            ...
            '<@shiro.hasPermission name="article:edit"><a class="btn btn-xs btn-primary" title="编辑" href="/article/update/' + trId + '"><i class="fa fa-edit"></i></a></@shiro.hasPermission>',
            '<@shiro.hasPermission name="article:delete"><a class="btn btn-xs btn-danger title="删除" btn-remove" data-id="' + trId + '"><i class="fa fa-trash-o"></i></a></@shiro.hasPermission>',
